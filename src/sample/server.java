...
public class server {
    ...
    public static void main(String[] args) {
        ...
        directory = new File("C:/Users/xsyyy/OneDrive/Desktop/ggwp");
        if ( ! directory.exists() ) {
    ...
    static class ConnectionHandler extends Thread {
        ...
        void sendFile(String fileName) throws Exception {
            ...
            if ( (! file.exists()) || file.isDirectory() ) {
                ...
                outgoing.println("ok");
                Scanner fileIn = new Scanner(new InputStreamReader(connection.getInputStream()));
                while (true) {
                    // Read and send lines from the file until
                    // an end-of-file is encountered.
                    String line = fileManager.readFile(fileName);
